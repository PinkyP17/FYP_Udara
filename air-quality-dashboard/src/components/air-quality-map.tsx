...
const AirQualityMap = forwardRef<{ closeAllPopups: () => void }, AirQualityMapProps>(
      ...
      `;
        ...
        markerElement.addEventListener('mouseenter', () => {
          if (selectedLocationRef.current?.id !== location.id) {
            const container = markerElement.querySelector('.marker-container') as HTMLElement;
            if (container) {
        ...
        `;
          ...
          popup.setHTML(popupContent).setLngLat([location.lng, location.lat]).addTo(map.current!);
